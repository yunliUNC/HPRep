##
## EXAMPLE RUN:
## python make_and_xor_runfile.py MY_113.MY_115_test /home/jurici/work/PLACseq/MAPS_pipe/results/mESC/ /home/jurici/work/PLACseq/analysis/binning_for_regression/new_set/final.replicated.narrowPeak /home/jurici/work/PLACseq/data/genomic_features/F_GC_M_MboI_5Kb_el.mm10.txt /home/jurici/work/PLACseq/analysis/binning_for_regression/new_set/ /home/jurici/work/PLACseq/analysis/binning_for_regression/new_set/ 5000 19 ./ NA 
##
...
def init(parser):
    fname = str(parser.OUT_FILE_PATH) + 'HPRep_'+parser.DATASET_NAME+'.split'
    outf = open(fname,'w')
...
def main():
    ...
    parser.prog = 'PROG'
    parser.description = "make_and_xor_runfile.py"
    ...
    parser.add_argument('OUT_FILE_PATH', help = 'directory where .split file will be stored. Must end with slash ')
